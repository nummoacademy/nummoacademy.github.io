/* ==========================================================================
   NEMMO Academy — Main JavaScript (Modular Production v3.2)
   ========================================================================== */
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    // 2. تفعيل Lucide Icons
    if (typeof lucide !== "undefined") {
        lucide.createIcons();
    }

    // 3. إدارة الوضع الليلي والنهاري المتوافق
    ...
    // 4. Mobile Navigation Drawer (مع Stop Propagation و aria-hidden)
    ...
    // 7. سلايدر آراء الطلاب (Vanilla JS Slider)
    ...
    // 8. إدارة نموذج التسجيل ونظام المسارات
    ...
    // 9. معالجة الإرسال عبر الواتساب مع التحقق الدقيق
    if (form) {
